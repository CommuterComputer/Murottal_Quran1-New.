...
import com.example.myapplication.tampilan.PlayerService;
import com.example.myapplication.tampilan.R;
...
import com.example.myapplication.asycn.LoadSong;
import com.example.myapplication.interfaces.SongListener;
import com.example.myapplication.ownmodal.ItemMyPlayList;
import com.example.myapplication.ownmodal.ItemSong;
import com.example.myapplication.ownmodal.MessageEvent;
import com.example.myapplication.utils.DBHelper;
import com.example.myapplication.utils.GlobalBus;
import com.example.myapplication.utils.Methods;
import com.example.myapplication.utils.PausableRotateAnimation;
...
public class ActivityBase extends AppCompatActivity implements View.OnClickListener {
    ...
    Boolean expan = false, rotationAnim = false, adsBanner = false;
        ...
        try{
            if (isPlay){
                ...
                if (!rotationAnim){
                    ...
                    View viewPag = viewPager.findViewWithTag("myview" + Constant.playPos);
                    newRotationAnimation();
                    imageView_pager = viewPag.findViewById(R.id.image);
    ...
    public void changePlayPauseIcon(Boolean isPlay) {
        if (!isPlay) {
            iv_music_play.setImageDrawable(getResources().getDrawable(R.mipmap.ic_play));
            iv_min_play.setImageDrawable(getResources().getDrawable(R.mipmap.ic_play));
        } else {
            iv_music_play.setImageDrawable(getResources().getDrawable(R.mipmap.pause));
            iv_min_play.setImageDrawable(getResources().getDrawable(R.mipmap.ic_play));
        }
        seekUpdated();
    }
